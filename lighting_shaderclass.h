...
public:
	...
	void Shutdown();
	bool Render(ID3D11DeviceContext*, D3DXMATRIX&, D3DXMATRIX&, D3DXMATRIX&, D3DXVECTOR3, MaterialBufferType,LightColorBufferType);
...
private:
	...
	bool SetShaderParameters(ID3D11DeviceContext*, D3DXMATRIX&, D3DXMATRIX&, D3DXMATRIX&, D3DXVECTOR3, MaterialBufferType,LightColorBufferType);
